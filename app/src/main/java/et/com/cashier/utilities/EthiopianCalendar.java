...
public class EthiopianCalendar {
     ...
     ** ********************************************************************************
     */
    public static final int JD_EPOCH_OFFSET_AMETE_ALEM   = -285019; // á‹“/á‹“
    public static final int JD_EPOCH_OFFSET_AMETE_MIHRET = 1723856; // á‹“/áˆ
    ...
    public EthiopianCalendar(int year, int month, int day, int era ) throws ArithmeticException {
    ...
    public void setEra ( int era ) throws ArithmeticException {
        if ( (JD_EPOCH_OFFSET_AMETE_ALEM == era)
            ...
            throw ( new ArithmeticException( "Unknown era: " + era + " must be either á‹“/á‹“ or á‹“/áˆ." ) );
        }
    }
